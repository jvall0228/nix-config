...
- `modules/shared/` — Nix settings applied to all hosts (nixpkgs config, flakes, caches).
...
- **Platform guards:** Use `lib.optionals pkgs.stdenv.isLinux` for platform-specific imports.
